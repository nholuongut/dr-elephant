...
package com.nholuongut.drelephant.spark.legacydata
...
import com.nholuongut.drelephant.spark.fetchers.statusapiv1._
...
object LegacyDataConverters {
  ...
  def convert(legacyData: SparkApplicationData): com.nholuongut.drelephant.spark.data.SparkApplicationData = {
    com.nholuongut.drelephant.spark.data.SparkApplicationData(
      legacyData.getAppId,
